...
Every PR needs **2 approvals** before merging.
...
| 1 Lead + 1 Member | ✅             |
| 2 Lead            | ✅             |
| 2 Member          | ❌ Not allowed |

**Rule of thumb:** at least 1 Lead reviewer must approve every PR.

Everyone is encouraged to review PRs (great for evidence of leadership, teamwork and contribution!). Members can still leave comments and request changes, but cannot solely approve.

MILP leads have been added to [CODEOWNERS](CODEOWNERS).
