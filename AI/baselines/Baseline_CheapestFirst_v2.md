...
Owner: Ali Alabdouli
Status: Updated with confirmed toy-model configuration (v2)
...
- `Baseline_CheapestFirst_v2.md` (this document) — supersedes `Baseline_CheapestFirst.md`, updated with confirmed toy-model sources and capacities; cost-based sort order remains a placeholder pending real `cost_per_ML`
